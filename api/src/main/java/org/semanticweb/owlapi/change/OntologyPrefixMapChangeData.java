 ...
 * @since 3.3
 */
public class OntologyPrefixMapChangeData extends OWLOntologyChangeData {
     ...
     */
    public OntologyPrefixMapChangeData(OWLDocumentFormat doc) {
        this.doc = checkNotNull(doc, "annotation must not be null");
    }
	...
	@Override
	public <R> R accept(OWLOntologyChangeDataVisitor<R> visitor) {
